...
/**Это два почти идентичных эпика, я в курсе, что можно из них сделать один,
 *  но большое количество условий оч сильно усложняет  мне понимание процесса.
 * поэтому пока каждый за что-то одно=)
 */
